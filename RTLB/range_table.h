...
public:
    ...
    // All the virtual address used here have been preprocessed and have 
tags
    ...
    void remapEntry(uint32_t id, uint64_t old_va_start, uint64_t 
...
private:
    ...
    void _insertMappings(range_entry &r_info, int p_low, int p_high, int 
a_low, int a_high, int seg_count, bool activate);
