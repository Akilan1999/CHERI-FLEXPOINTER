...
\begin{minipage}[t]{0.4\linewidth}
  \includegraphics[width=2\textwidth]{diagrams/HighOverviewArchitecture24.png}
\end{minipage}

\subsection{Range creation and huge pages}
\begin{minipage}[t]{0.4\linewidth}
  \includegraphics[width=2\textwidth]{diagrams/AllocationOverview24.png}
\end{minipage}
...
to the CHERI 128-bit bounds compression scheme. The memory chunk defined by the upper and lower bounds is 
...
\smallskip\noindent
The figure above illustrates a straightforward use-case in which the dark pink line represents a single, 
...
\begin{minipage}[t]{0.4\linewidth}
  \includegraphics[width=2\textwidth]{diagrams/SoftwareStack24.png}
\end{minipage}
