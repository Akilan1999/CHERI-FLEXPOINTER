...
Ranges of memory are created based on bounds encoded to the FAT-Pointer. 
The Chuck between the following bounds is physically contiguous.
This is done via the FreeBSD kernel Contig memory allocator. 
