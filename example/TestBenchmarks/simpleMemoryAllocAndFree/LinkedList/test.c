...
int main(int argc, const char * argv[])
{
	...
	Int minElemensFactor = 3;  // First measurement is 2^this number of elements.
	Int maxElemsFactor = 15; // Last measurement is 2^this number of elements. 30 == 16GB of memory
